...
export default function ProductsChildDetails() {
    ...
    return (
        <>
            <div className="Parent_items" >
                ...
                <div className="hidden_Child" style={{ display: List_Display[0] }}>
                    <p className='ItemHeading'>More IN MEN'S TOP WEAR </p>
                ...
                <div className="hidden_Child" style={{ display: List_Display[1] }}>
                    <p className='ItemHeading'> MORE IN MEN'S BOTTOM WEAR </p>
                    <p className='ItemLists'> All </p>
                ...
                <div className="hidden_Child" style={{ display: List_Display[2] }}>
                    <p className='ItemHeading'> MORE IN WOMEN ETHNIC</p>
                    <p className='ItemLists'> All </p>
                ...
                <div className="hidden_Child" style={{ display: List_Display[3] }}>
                    <p className='ItemHeading'>   MORE IN WOMEN WESTERN</p>
                    <p className='ItemLists'> All </p>
                ...
                <div className="hidden_Child" style={{ display: List_Display[4] }}>
                    <p className='ItemHeading'>   MORE IN MEN FOOTWEAR</p>
                    <p className='ItemLists'> All </p>
                ...
                <div className="hidden_Child" style={{ display: List_Display[5] }}>
                    <p className='ItemHeading'>   MORE IN WOMEN FOOTWEAR</p>
                    <p className='ItemLists'> All </p>
                ...
                <div className="hidden_Child" style={{ display: List_Display[6] }}>
                    <p className='ItemHeading'>    MORE IN WATCHES AND ACCESSORIES</p>
                    <p className='ItemLists'> All </p>
                ...
                <div className="hidden_Child" style={{ display: List_Display[7] }}>
                    <p className='ItemHeading'>    MORE IN BAGS SUITCASES & LUGGAGE</p>
                    <p className='ItemLists'> All </p>
                ...
                <div className="hidden_Child" style={{ display: List_Display[8] }}>
                    <p className='ItemHeading'>     MORE IN KIDS </p>
                    <p className='ItemLists'> All </p>
                ...
                <div className="hidden_Child" style={{ display: List_Display[9] }}>
                    <p className='ItemHeading'>  MORE IN ESSENTIALS </p>
                    <p className='ItemLists'> All </p>
                ...
                <div className="hidden_Child" style={{ display: List_Display[10] }}>
                    <p className='ItemHeading'>    MORE IN WINTER </p>
                    <p className='ItemLists'> All </p>
