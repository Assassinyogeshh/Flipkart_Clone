...
function DisplayBuyingItemDetails() {
    ...
    <>
      <div className="ByingProductDetails">
        ...
        <div className="chosdItemRating">
          <button className="chosdprdctrating">{firstObjData.rating}  <img className='starIMG'  src='/green_star.png'/></button>
     ...
     <div className="ContaininTwoSeprateRatings">
        <div className="GivenRatingProducts">
          <span className="hiddencountRating other_hiddenRating">
            <p className='largeFont'>{firstObjData.rating} <img className='black_starIMG'  src='/black_star.png'/></p>
...
export default DisplayBuyingItemDetails
