      ...
      <div className="CurrentProducts">
                ...
                <li className="currentProductDetails">
                  ...
                  <div className="ItemDetails">
                    ...
                    <div className="itemRating">
                      <span className="countRating" onMouseOver={() => showHiddenRatings([index])}>{selectedObj.rating} <img className='starIMG' src='/green_star.png'/></span>
                      <div className="hiddenItemrating" onMouseLeave={() => hideRatings([index])} style={{ display: displayRating[index] }}>
                        <span className="hiddencountRating">
                          <p className='largeFont'>{selectedObj.rating} <img className='starIMG'  src="/black_star.png"/></p>
        ...
        <div className="multiple_page">
          <ul className="numberOfpages">
            <li className="page_number number_page" onClick={()=>selectedPageNumber(1)} style={{backgroundColor:selectedPage[1].backgroundColor, color:selectedPage[1].color}}>1</li>
